...
//fill the DoubleMatrix xMat with csv data stored in the .csv file format
...
//Entry point of johansesn test of the four cases; case 1 is stationary series, case 2 is random walk with no cointegration ...

//The major computation bulk is relayed to the JohansenHelper function.

//In JohansenHelper, the doMaxEigenValueTest(nlags) is the major function (~200 lines of hard code) that generates
//the required statistics.

//These statistics are subsequently retrieved via CointegrationCount and GetOutStats functions.
...
#if 1
    for (int i = 0; i < 4; i++) // generating random walk
    {
        cout << endl;
        switch (i)
        {
