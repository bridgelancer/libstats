...
namespace
{
    //This is probably one that can estimate data set trend/drift. The power of the these critical values remains in doubt in situation without trend/drif or both. 

    //c.f. http://homes.chass.utoronto.ca/~floyd/statabs.pdf
