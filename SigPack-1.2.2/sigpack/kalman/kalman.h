...
namespace sp
{
    ...
    class KF
    {
        ...
        public:
            ...
            void predict(void)
            {
                 arma::mat u0(L,1,arma::fill::zeros); //create u0_{number of measurements,1} and filled with zeros
                 predict(u0); // equivalent to
            //  x = A*x;
            //  P = A*P*A.t() + Q;  i.e. no correction of the new state based on measurements
            }
